...
// 2. (i checked for 3 conditions, too much, too little or just right)
...
//solution from course (he checked for too little or too much):
console.log(
...
// dogs.forEach(dog => {
//   if (dog.curFood < dog.recFood) ownersEatTooLittle.push(dog.owners);
...
// );
// but i wouldn't know how many owneres are there so this is the solution:
...
// 7.
const dogsOkay = dogs.filter(checkEating);
console.log(dogsOkay);

//8.Create a shallow copy of the dogs array and sort it by recommended food portion in an ascending order (keep in mind that the portions are inside the array's objects)
const recOrder = dogs.slice().sort((a, b) => a.recFood - b.recFood);
